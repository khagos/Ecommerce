    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset id="address">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-postcode"><?php echo $entry_postcode; ?>
              <span>
                <a data-toggle="popover" title="How to generate Dejaf code" data-content="
                  Step 1 Download the app <a href='https://play.google.com/store/apps/details?id=com.tinydavid.snoocode'>DejafCode</a>DejafCode
                  Step 2 Step outside where there is a clear sky
                  Step 3 Generate DejafCode"><i class="fa fa-question-circle"></i>
                </a>
              </span>
            </label>
            <div class="col-sm-10">
